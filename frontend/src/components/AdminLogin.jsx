...
//       console.log("id_token (first 30 chars):", id_token?.slice?.(0, 30));
//       const resp = await apiPost("/auth/oauth/google", { id_token, restaurantSlug });
//       if (resp?.token) {
//         setToken(resp.token);
...
//         </div>
//         <p className="text-sm text-center text-gray-500">Sign in with an admin Google account</p>
//       </div>
//     </div>
//   );
// }
